...
use App\Service\VeiculoMarcaService;
...
class VeiculoMarcaController extends DefaultController
{
    ...
    #[OA\Get(
        path: '/api/veiculo/marca/select',
        summary: 'Select de marcas de veículo',
        tags: ['Veículo'],
        security: [['api_key' => []]],
        responses: [
    ...
    {
        try {
            return $this->jsonResponse($response, $session, $this->veiculoMarcaService->select());
        } catch (Throwable $e) {
