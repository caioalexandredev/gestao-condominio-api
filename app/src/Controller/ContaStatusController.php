...
use App\Service\ContaStatusService;
...
class ContaStatusController extends DefaultController
{
    ...
    #[OA\Get(
        path: '/api/conta/status/select',
        summary: 'Select de status de conta',
        tags: ['Financeiro'],
        security: [['api_key' => []]],
        responses: [
    ...
    {
        try {
            return $this->jsonResponse($response, $session, $this->contaStatusService->select());
        } catch (Throwable $e) {
