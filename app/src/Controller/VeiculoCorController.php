...
use App\Service\VeiculoCorService;
...
class VeiculoCorController extends DefaultController
{
    ...
    #[OA\Get(
        path: '/api/veiculo/cor/select',
        summary: 'Select de cores de veículo',
        tags: ['Veículo'],
        security: [['api_key' => []]],
        responses: [
    ...
    {
        try {
            return $this->jsonResponse($response, $session, $this->veiculoCorService->select());
        } catch (Throwable $e) {
