...
use App\Service\ContaPagarService;
...
class ContaPagarController extends DefaultController
{
    ...
    #[OA\Post(
        ...
        summary: 'Realiza o cadastro completo de uma conta a pagar',
        tags: ['Contas a Pagar'],
        security: [['api_key' => []]],
    ...
    ): ResponseInterface 
    {
        try {
            ...
            $this->contaPagarService->cadastrar($data);
    ...
    #[OA\Get(
        path: '/api/conta/pagar/listagem',
        summary: 'Listagem de Contas a Pagar do Sistema',
        tags: ['Contas a Pagar'],
        security: [['api_key' => []]],
        parameters: [
            new OA\Parameter(
    ...
    ): ResponseInterface 
    {
        try {
            ...
            $result = $this->contaPagarService->listagem(
                $data['descricao'] ?? null,
                $data['tipo'] ?? null,
    ...
    ): ResponseInterface 
    {
        try {
            ...
            return $this->jsonResponse($response, $session, $this->contaPagarService->consultarDados($data['id']));
        } catch (Throwable $e) {
            return $this->handleException($response, $e, $session);
        }
    }
    ...
    #[OA\Delete(
        path: '/api/conta/pagar/{id}',
        summary: 'Excluir Conta a Pagar do Sistema',
        tags: ['Contas a Pagar'],
        security: [['api_key' => []]],
        parameters: [
            new OA\Parameter(
    ...
    ): ResponseInterface
    {
        try{
            ...
            $this->contaPagarService->deletar($data['id']);
    ...
    #[OA\Put(
        path: '/api/conta/pagar/{id}',
        summary: 'Atualiza o cadastro completo de conta a pagar',
        tags: ['Contas a Pagar'],
        security: [['api_key' => []]],
        parameters: [
            new OA\Parameter(
    ...
    ): ResponseInterface 
    {
        try {
            ...
            $this->contaPagarService->atualizar($data['id'], $data);
